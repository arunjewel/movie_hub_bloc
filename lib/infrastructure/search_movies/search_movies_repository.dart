...
import '../../domain/search_movies/search_movies/movie_data.dart';
import '../../domain/search_movies/search_movies/search_movies.dart';
  ...
  Future<Either<MainFailure, List<Movie>>> searchMovies(
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        final List<Movie> searchMoviesList =  (response.data['data']['movies'] as List).map((e) {
